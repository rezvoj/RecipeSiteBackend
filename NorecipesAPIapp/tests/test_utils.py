...
import NorecipesAPIapp.utils.exception as Exceptions
import NorecipesAPIapp.utils.filtering as Filtering
import NorecipesAPIapp.utils.permission as Permissions
import NorecipesAPIapp.utils.security as Security
import NorecipesAPIapp.utils.validation as Validation
import NorecipesAPIapp.utils.verification as Verification
import NorecipesAPIapp.tests.media_utils as media_utils
from NorecipesAPIapp.apps import Config
from NorecipesAPIapp.utils.exception import VerificationException
from NorecipesAPIapp.models.timestamp import utc_now
from NorecipesAPIapp.models.user import User, EmailRecord
from NorecipesAPIapp.models.recipe import Recipe, Rating, SubmitStatuses
...
@override_settings(ROOT_URLCONF='NorecipesAPIapp.tests.test_utils')
class TestExceptionHandler(APITestCase):
    def setUp(self):
        self.log = logging.getLogger('NorecipesAPIapp.utils.exception')
...
class TestMedia(APITestCase):
    ...
    def test_path_traversal_attack(self):
        response: Response = self.client.get('/media/../NorecipesAPIapp/settings.py')
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
