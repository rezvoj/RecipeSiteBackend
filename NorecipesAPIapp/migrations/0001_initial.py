    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favoured_by', models.ManyToManyField(related_name='fav_recipes', to='NorecipesAPIapp.user')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipe', to='NorecipesAPIapp.user')),
            ],
            options={
                'abstract': False,
            },
