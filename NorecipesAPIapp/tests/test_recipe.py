...
import NorecipesAPIapp.tests.media_utils as media_utils
from NorecipesAPIapp.models.timestamp import utc_now
from NorecipesAPIapp.models.user import User
from NorecipesAPIapp.models.recipe import Recipe, Rating, RecipeInstruction, RecipeIngredient, RecipePhoto, SubmitStatuses
from NorecipesAPIapp.models.categorical import Category, Ingredient, UserIngredient
...
class TestRecipeCUD(APITestCase):    
    ...
    @patch('NorecipesAPIapp.apps.Config.PerRecipeLimits.categories', 1)
    ...
    @patch('NorecipesAPIapp.apps.Config.ContentLimits.recipe', (1, 24))
    ...
    @patch('NorecipesAPIapp.apps.Config.ContentLimits.recipe_moderator', (1, 24))
...
class TestRecipePhotoCUD(APITestCase):
    ...
    @patch('NorecipesAPIapp.apps.Config.PerRecipeLimits.photos', 2)
...
class TestRecipeInstructionCUD(APITestCase):
    ...
    @patch('NorecipesAPIapp.apps.Config.PerRecipeLimits.instructions', 2)
...
class TestRecipeIngredients(APITestCase):
    ...
    @patch('NorecipesAPIapp.apps.Config.PerRecipeLimits.ingredients', 1)
...
class TestRatingCUD(APITestCase):
    ...
    @patch('NorecipesAPIapp.apps.Config.ContentLimits.rating', (0, 24))
